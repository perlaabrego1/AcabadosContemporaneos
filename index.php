    ...
    <head>
        ...
        <style type="text/css">
            ...
            * {padding: 0; margin: 0; font-family: century gothic; text-align: center;}
            form {box-shadow: inset 0 0 0 var(--border-size) currentcolor;padding: 50px 50px; background-color: #001a1a66;  margin-top: 70px; padding-top: 28px; margin-bottom: 50px}
